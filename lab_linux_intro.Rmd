...
or they can be downloaded if you are not on UPPMAX at the moment, [files.tar.gz](data/linux/files.tar.gz) (instruction on how to download further down)
...
```{r,echo=FALSE,comment="",class.output="bash"} 
cat(paste0("cp -r /sw/share/compstore/courses/ngsintro/linux_tutorial/* /proj/",upid,"/nobackup/<username>/linux_tutorial"))
```
...
`r fa1("lightbulb")` &nbsp; Remember to tab-complete to avoid typos and too much writing.

If you are unable to copy the files on UPPMAX, you can download the files instead of copying them. This is done with the command `wget` (*web get*). It works kind of the same way as the `cp` command, but you give it a source URL instead of a source file, and you specify the destination by giving it a prefix, a path that will be appended in front on the file name when it's downloaded.
...
```bash
[valent@milou2 linux_tutorial]$ ls -la
total 512
drwxrwsr-x 12 valent g2019020   2048 Sep 24 13:19 .
drwxrwsr-x  6 valent g2019020   2048 Sep 24 13:19 ..
drwxrwsr-x  2 valent g2019020   2048 Sep 19  2012 a_strange_name
drwxrwsr-x  2 valent g2019020   2048 Sep 19  2012 backed_up_proj_folder
drwxrwsr-x  2 valent g2019020   2048 Sep 19  2012 external_hdd
-rwxrwxr-x  1 valent g2019020  17198 Sep 24 13:19 files.tar.gz
drwxrwsr-x  2 valent g2019020   2048 Sep 19  2012 important_results
drwxrwsr-x  2 valent g2019020 129024 Sep 19  2012 many_files
drwxrwsr-x  2 valent g2019020   2048 Sep 19  2012 old_project
-rwxrwxr-x  1 valent g2019020      0 Sep 24 13:19 other_file.old
drwxrwsr-x  2 valent g2019020   2048 Sep 19  2012 part_1
drwxrwsr-x  2 valent g2019020   2048 Sep 19  2012 part_2
drwxrwsr-x  2 valent g2019020   2048 Jan 28  2012 this_has_a_file
drwxrwsr-x  2 valent g2019020   2048 Jan 28  2012 this_is_empty
-rwxrwxr-x  1 valent g2019020      0 Sep 19  2012 useless_file
...
total 0
-rwxrwxr-x 1 valent g2019020 0 Sep 19  2012 dna_data_analysis_result_file_that_is_important-you_should_really_use_tab_completion_for_file_names.bam
-rwxrwxr-x 1 valent g2019020 0 Sep 19  2012 temp_file-1
-rwxrwxr-x 1 valent g2019020 0 Sep 19  2012 temp_file-2
[valent@milou2 linux_tutorial]$
```
...
`r fa1("clipboard-list")` &nbsp; Now do the same, but move the important DNA data file!
...
total 0
-rwxrwxr-x 1 valent g2019020 0 Sep 19  2012 dna_data_analysis_result_file_that_is_important-you_should_really_use_tab_completion_for_file_names.bam
-rwxrwxr-x 1 valent g2019020 0 Sep 19  2012 last_years_data
-rwxrwxr-x 1 valent g2019020 0 Sep 19  2012 temp_file-1
[valent@milou2 linux_tutorial]$
```
...
total 448
drwxrwsr-x 2 valent g2019020   2048 Sep 19  2012 a_better_name
drwxrwsr-x 2 valent g2019020   2048 Sep 24 13:40 backed_up_proj_folder
drwxrwsr-x 2 valent g2019020   2048 Sep 19  2012 external_hdd
-rwxrwxr-x 1 valent g2019020  17198 Sep 24 13:36 files.tar.gz
drwxrwsr-x 2 valent g2019020   2048 Sep 24 13:40 important_results
drwxrwsr-x 2 valent g2019020 129024 Sep 19  2012 many_files
drwxrwsr-x 2 valent g2019020   2048 Sep 19  2012 old_project
-rwxrwxr-x 1 valent g2019020      0 Sep 24 13:36 other_file.old
drwxrwsr-x 2 valent g2019020   2048 Sep 19  2012 part_1
drwxrwsr-x 2 valent g2019020   2048 Sep 19  2012 part_2
drwxrwsr-x 2 valent g2019020   2048 Jan 28  2012 this_has_a_file
drwxrwsr-x 2 valent g2019020   2048 Jan 28  2012 this_is_empty
...
total 0
-rwxrwxr-x 1 valent g2019020 0 Sep 24 13:46 last_years_data
[valent@milou2 linux_tutorial]$
```
...
`r fa1("exclamation-circle")` &nbsp; **IMPORTANT: There is no trash bin in Linux. If you delete a file, it is gone. So be careful when deleting stuff.**
...
drwxrwsr-x 2 valent g2019020   2048 Sep 19  2012 a_better_name
drwxrwsr-x 2 valent g2019020   2048 Sep 24 13:40 backed_up_proj_folder
drwxrwsr-x 2 valent g2019020   2048 Sep 24 13:46 external_hdd
-rwxrwxr-x 1 valent g2019020  17198 Sep 24 13:36 files.tar.gz
drwxrwsr-x 2 valent g2019020   2048 Sep 24 13:40 important_results
drwxrwsr-x 2 valent g2019020 129024 Sep 19  2012 many_files
drwxrwsr-x 2 valent g2019020   2048 Sep 19  2012 old_project
...
total 0
-rwxrwxr-x 1 valent g2019020 0 Jan 28  2012 file
[valent@milou2 linux_tutorial]$
```
...
`r fa1("clipboard-list")` &nbsp; Now, we are looking for that really good script we wrote a couple of months ago in that other project. Look in the project's folder, **old_project** and find the script.

```bash
[valent@milou2 linux_tutorial]$ ll old_project/
total 96
-rwxrwxr-x 1 valent g2019020 39904 Sep 19  2012 a
-rwxrwxr-x 1 valent g2019020     0 Sep 19  2012 stuff_1
-rwxrwxr-x 1 valent g2019020  1008 Sep 19  2012 the_best
[valent@milou2 linux_tutorial]$
```

Not so easy with those names.. We will have to use less to look at the files and figure out which is which. We use `less` to view the file.

```bash
$ less <filename>
```

`r fa1("lightbulb")` &nbsp; Press <kbd>q</kbd> to close it down, use arrows to scroll up/down.
...
`r fa1("lightbulb")` &nbsp; Press <kbd>Ctrl+X</kbd> to close it down, use arrows to scroll up/down).
...
`r fa1("exclamation-circle")` &nbsp; **DO NOT** run this command, it's just an example.
...
total 0
-rwxrwxr-x 1 valent g2019020 0 Sep 19  2012 file_1.txt
-rwxrwxr-x 1 valent g2019020 0 Sep 19  2012 file_2.txt
[valent@milou2 linux_tutorial]$ ll part_2
total 0
-rwxrwxr-x 1 valent g2019020 0 Sep 19  2012 file_3.txt
-rwxrwxr-x 1 valent g2019020 0 Sep 19  2012 file_4.txt
-rwxrwxr-x 1 valent g2019020 0 Sep 19  2012 garbage.tmp
-rwxrwxr-x 1 valent g2019020 0 Sep 19  2012 incomplete_datasets.dat
[valent@milou2 linux_tutorial]$
```
...
`r fa1("clipboard-list")` &nbsp; Try to figure out the solution on your own. Then check the answer below.
...
`r fa1("lightbulb")` &nbsp; Press <kbd>q</kbd> to exit.
...
If you still have time left on the lab and you finished early, check out the [advanced linux exercises](lab_linux_adv.html)!
