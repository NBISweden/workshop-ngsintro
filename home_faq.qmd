...
accordion:
  - faq:
    ...
    - header: 2. Am I eligible to apply?
      body: |
        This is a national course open to PhD students, postdocs, group leaders, research assistants, core facility staff and other laboratory, medical or veterinary personnel. A background in genetics, cell biology, biomedicine, biochemistry, veterinary, bioinformatics or comparable is desirable. 
        ...
        You need to be affiliated to an institution (university, company etc) as we cannot invoice individuals. Applications in connection with Arbetsförmedlingen / Trygghetsstiftelsen needs to be handled on a case-by-case basis. Applicants affiliated to a Swedish institution are prioritized due to our funding. 
    ...
    - header: 6. What computer do I need for this workshop?
      body: You are required to bring your own computer. A unix based operating system (Linux / Ubuntu / Apple Mac OS) will be easier but not required. We can also work with Microsoft Windows OS. No particular system requirements are set since we do not run any compute locally. We will work on a remote cluster. It is important that you install the softwares listed in the pre-course instructions **BEFORE** the workshop starts. Every course, we have a couple of participants who do not have admin rights to install software and therefore cannot complete some of the exercises.
