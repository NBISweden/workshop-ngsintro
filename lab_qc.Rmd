...
You can download the files you just generated to you laptop and open them in your webbrowser. Open a new terminal window in your laptop and navigate to a suitable folder, but do not log in to UPPMAX. Download the generated .html files to your laptop with this command:
```{r,echo=FALSE,comment="",class.output="bash"}
...
Then open a web browser and open the downloaded files in the browser. 

## Option 2 - use precomputed results
Alternatively, you can look at the same files that we have uploaded to the course website by clickin on the links below: 
