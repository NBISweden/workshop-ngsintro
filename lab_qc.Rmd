...
## Connect to Uppmax
During this lab it is best to connect to UPPMAX via a remote desktop (ThinLinc). Instructions for this is available in Canvas under Content/Additional content/Connecting to Uppmax. Please follow the instructions in section 1.2 Remote desktop connection.
