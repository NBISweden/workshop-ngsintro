...
```
# FastQC
FastQC performes a series of quality control analyses, called modules. The output is a HTML report with one section for each module, and an evaluation of whether the results seem entirely normal (green tick), slightly abnormal (orange exclamation mark) or very unusual (red cross). 
