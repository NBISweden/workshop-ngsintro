...
# Check the results
Now its time to look at the results. You can download the files you just generated to you laptop and open them in your webbrowser. To do that you can use this command:
```{r,echo=FALSE,comment="",class.output="bash"}
