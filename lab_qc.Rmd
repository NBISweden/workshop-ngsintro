...
Then open a web browser and open the downloaded files in the browser. The files are located in the folder that you were standing in when you downloaded them. 
