...
```
# FastQC
FastQC performes a series of quality control analyses, called modules. The output is a HTML report with one section for each module, and a summary evaluation of whether the results of the module seem entirely normal (green tick), slightly abnormal (orange exclamation mark) or very unusual (red cross). 
...
In this lab we will mainly focus on the Per Base Sequence Quality and Sequence Length Distribution modules. 
...
2. Is there any warnings or failures in the Per Base Sequence Quality module? 
...
5. Is there ay warnings or failures in the Sequence Length Distribution module?
