...
```
Sometimes it can be slow to look at graphical files via SSH. In the interest of saving time in this short lab, we have made the output files that you just created available through the links below:
