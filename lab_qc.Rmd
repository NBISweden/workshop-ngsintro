...
For more information and reason for failed tests, please look at the [FastQC documentation](https://www.bioinformatics.babraham.ac.uk/projects/fastqc/Help/3%20Analysis%20Modules/2%20Per%20Base%20Sequence%20Quality.html). 
### Questions
1. Which positions in the reads have a median phred-score above 28 (very good quality calls) in each sample?
2. Red x-marks are indications of potential problems. Does any of the samples have red x-marks? Why are they marked in red? Please look in the documentation linked above.

## Sequence Lenght Distribution 
This module shows the length distribution of the reads in the file. 
### Questions
3. How long are the reads?
4. Does any sample have more than one peak in the lenght distribution?
