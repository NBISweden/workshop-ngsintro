...
The most important thing to know about read groups for today's workshop is that **read groups are needed for HaplotypeCaller**, and **the SM flag should be the same as the sample name**. This means that you have to modify the code when running BWA for another sample by replacing "HG00097" with the new sample name. 
If ou would like to know more about read groups please read this article at [GATK-forum](https://gatk.broadinstitute.org/hc/en-us/articles/360035890671-Read-groups). 
