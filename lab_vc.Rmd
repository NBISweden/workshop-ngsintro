...
What you need to know about read groups for today's workshop is that **read groups are needed for HaplotypeCaller**, and **the SM tag should hold the sample name**. This means that you have to modify the code when running BWA for another sample by replacing "HG00097" with the new sample name. 
