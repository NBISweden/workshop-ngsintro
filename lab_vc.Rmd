...
If no jobs are listed you should allocate a job for this lab. If you already have an active job allocation please proceed to the step "Connect to this node" below. Use this code to allocate a core on day 1 of variant-calling:
```{r,echo=FALSE,comment="",class.output="bash"}
...
squeue -u <username>
```
You should now see that you have an active job allocation. The compute node for your job is listed under the nodelist header.
