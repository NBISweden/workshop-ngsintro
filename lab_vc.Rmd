...
You can run all commands one by one in the terminal as you did in the first step of the workshop.  
However, if you are interested and if you have time, this is a good opportunity to learn how to write a simple SBATCH script and run all steps automatically. If you are interested in this, please see the [SBATCH script](#sbatchscript) section below.   
...
If you run out of time you can use the precompiled bam files HG00097.bam, HG00100.bam and HG00101.bam available in
```{r,echo=FALSE,comment="",class.output="bash"}
cat(paste0(bamdir))
```
