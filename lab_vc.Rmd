...
`r fa1("clipboard-list")` &nbsp; Compare the size of the SAM and BAM files using `ls -l`
...
`r fa1("clipboard-list")` &nbsp; How many duplicates were detected? Check the metrics file. 
...
`r fa1("comments")` &nbsp; You can now try to answer these questions:
...
<div class="boxy">
<span class="ifa">`r fa2("comments")`</span> You can try to answer these questions:
