...
You also need to specify how many threads `BWA mem` should use, which should be the same as the number of cores you have access to. This is defined by the code `-t 1` below.
