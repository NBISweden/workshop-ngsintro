...
You can run the commands one by one in the terminal as you did before. We have also made intermediary files avaiable in case you don't have time to complete all steps, please see links under each analysis step. 
