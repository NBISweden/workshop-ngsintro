...
20. How many data lines do the cohort.g.vcf file have? You can use the linux command `grep -v "#" cohort.g.vcf` to extract all lines in "cohort.g.vcf" that don't start with "#", then `|`, and then `wc` to count those lines.  
21. How many data lines do the cohort.vcf file have?  
22. Explain the difference in number of data lines?  
23. Look at the header line of the cohort.vcf file. What columns does it have? 
...
Download the files cohort.g.vcf and cohort.vcf to your *local workspace* as described [above]{#downloaddata}. Then open the file in IGV as described [above]{#vcfinigv} and look at it.  
