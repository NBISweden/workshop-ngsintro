...
Now we will detect short variants in the bam file using GATK's `HaplotypeCaller`. This should be done in your *UPPMAX workspace. Use pwd to check if you are standing in the correct directory:
```{r,echo=FALSE,comment="",class.output="bash"}
cat(paste0('/proj/',upid,'/nobackup/<username>/ngsworkflow'))
```
Then run:
