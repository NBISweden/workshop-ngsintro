...
Please use this command to align the reads, add the read group, and sort the bam file:
```bash
...
```
-t 1 is the number of threads, which should be equal to the number of cores you booked.  
