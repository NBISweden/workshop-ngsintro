...
To run this workshop you need to know that **read groups are needed for HaplotypeCaller** and **the SM field should contain the sample name**. When running BWA for another sample later on you therefore have to replace "HG00097" in the read group with the new sample name.  
To learn more about read groups for your future work, please read [this article](https://gatk.broadinstitute.org/hc/en-us/articles/360035890671-Read-groups) at GATK forum.  
