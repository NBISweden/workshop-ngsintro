...
For now you need to know that **read groups are needed for HaplotypeCaller**, and **the SM field should contain the sample name**. When running BWA for another sample later on you have to replace "HG00097" in the read group with the new sample name. 
