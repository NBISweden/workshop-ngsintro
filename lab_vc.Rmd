...
In this workshop we will use sequencing data for the region chr2:136545000-136617000 in the 3 samples listed above to illustrate variant calling in NGS data. We will use chromosome 2 from hg19 as reference genome.  
...
```
Now lets look at the details of one specific genetic variant at position 2:136234279:
```bash
grep '136234279' HG00097.vcf
```
...
12. What are the allelic depths for the reference and alternative alles for sample HG00097 at position 2:136234279?
