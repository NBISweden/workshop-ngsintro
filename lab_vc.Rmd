...
cd ngsworkflow
```
**Make sure you are located in /proj/snicXXXX-XX-XXX/nobackup/`<username>`/ngsworkflow for the rest of this lab.**
...
pwd
```
Should return **'/proj/',upid,'/nobackup/`<username>`/ngsworkflow'**
```
