...
For now you need to know that **read groups are needed for HaplotypeCaller**, and **the SM field of the read group should containt the name of the sample**. When running BWA for another sample later on you have to replace "HG00097" in the read group with the new sample name. 
Please read [this article](https://gatk.broadinstitute.org/hc/en-us/articles/360035890671-Read-groups) at GATK forum if you would like to know more about read groups. 
