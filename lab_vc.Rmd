...
If you run out of time, please click below to get a link precomputed bam files. 
...
If you run out of time, please click below to get a link to the precomputed g.vcf files.
```{r,accordion=TRUE,block.title=TRUE,echo=FALSE,comment="",class.output="sh"}
...
If you run out of time, please click below to get a link to the precomputed cohort.g.vcf and cohort.vcf files:
```{r,accordion=TRUE,block.title=TRUE,echo=FALSE,comment="",class.output="sh"}
...
This section is only for those of you who want to learn how to run analyses automatically in bash scripts. 
