...
If no jobs are listed you should allocate a job for this lab. If you already have an active job allocation please proceed to the step [Connect to the node](#connecttonode) below.<br/>
...
Connect to the node: {#connecttonode }
```bash
ssh -Y <nodename>
```
