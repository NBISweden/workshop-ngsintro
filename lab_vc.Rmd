...
The first step in GATK's best pracice variant calling workflow is to run BWA mem for each sample exactly as you did in [Variant calling in cohort](#bwa_joint). Please continue with the bam files generated in step 2.1 for the subsequent steps here.  
