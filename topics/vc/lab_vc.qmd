...
```{r,echo=FALSE,comment="",class.output="bash"}
cat(paste0('salloc -A ',upid,' -t 04:00:00 -p shared --mem=6Gb --no-shell'))
```
...
```{r,echo=FALSE,comment="",class.output="bash"}
cat(paste0('cd /cfs/klemming/projects/supr/',upid,'/username/ngsworkflow'))
```
...
```{r,echo=FALSE,comment="",class.output="bash"}
cat(paste0('/cfs/klemming/projects/supr/',upid,'/username/ngsworkflow'))
```
