...
Get information about a project including quota, usage and members.
...
```
+===================+==============================================================+
| Storage project   | naiss2025-22-1240                                            |
+-------------------+--------------------------------------------------------------+
| Title             | Introduction to bioinformatics using NGS data HT 2025        |
+-------------------+--------------------------------------------------------------+
| PI                | mdahlo                                                       |
+-------------------+--------------------------------------------------------------+
| Duration          | 2025-09-16 -> 2026-03-01                                     |
+-------------------+--------------------------------------------------------------+
| Members           | dianaek jwhelan kribub mdahlo royfranc                       |
+-------------------+--------------------------------------------------------------+
| Path              | /cfs/klemming/projects/supr/naiss2025-22-1240                |
+-------------------+--------------------------------------------------------------+
| Quota             | 500.00 GiB                                                   |
+-------------------+--------------------------------------------------------------+
| File quota        | 1000000                                                      |
+-------------------+--------------------------------------------------------------+
| Stored            | 2.61 GiB (0.52%)                                             |
+-------------------+--------------------------------------------------------------+
| Stored files      | 572 (0.06%)                                                  |
+===================+==============================================================+
```

### User activity

List last activity in a directory for all users in a project.

```sh
bash /sw/courses/utils/list_modification_times.sh /cfs/klemming/projects/supr/{{< meta id_project >}}/
```
