...
# Interactive session 
On Tetralith you enter the *login node*, which is not intended for compute intensive tasks. You should therefore book a compute node, or in this case three cores (please adjust the time depending on what lab you will be working on):
...
When you have the UPPMAX singularity image up and running you can follow regular lab instructions, except that you should not do the step "logon to a node" in the regular instructions and you should work in the "cluster workspace" defined here.
