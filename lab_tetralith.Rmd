...
When you have the UPPMAX singularity image up and running you can follow regular lab instructions, except that you should not do the step "connect to UPPMAX" and "logon to a node" in the regular instructions, and you should work in the cluster workspace defined here.
