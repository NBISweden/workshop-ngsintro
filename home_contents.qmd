---
title: "Contents"
description: "Course materials organised by topic.<br>Slides: {{< fa file-powerpoint >}} / {{< fa file-pdf >}}, Labs: {{< fa file-lines >}}, Videos: {{< fa brands youtube >}}"
date: ""
toc: false
...
::: {.callout-note}
Note that the presentations and videos may not be in sync because the presentations were updated while the videos are from previous workshops.
:::
...
- NGS technologies and challenges [{{< fa brands youtube >}}](https://youtu.be/5sUzkrucL1E) [{{< fa file-pdf >}}](https://drive.google.com/file/d/14kfPifL52eMTZs2jsr2ykPehFBVpAxWr/view?usp=sharing)
- NGS Long Reads and Pipelines [{{< fa brands youtube >}}](https://youtu.be/6RBhfMvDkSI) [{{< fa file-pdf >}}](https://drive.google.com/file/d/1U_oVEuTTKwk7zxVP_CGR5zgHP6Jd_1Oi/view?usp=sharing)
