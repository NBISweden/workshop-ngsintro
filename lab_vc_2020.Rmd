...
```
If you would like more help with creating the sbatch script, please look at our [example solution](https://github.com/NBISweden/workshop-ngsintro/scripts/reseq/joint_genotyping.sbatch).  
