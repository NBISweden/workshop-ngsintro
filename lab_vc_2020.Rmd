...
```
If you have an active job reservation you can use this, and run the script as a normal bash script:
```bash
./joint_genotyping.sbatch
```
If you would like more help with creating the sbatch script, please look at our [example solution](scripts/reseq/joint_genotyping.sbatch).  
