...
It is up to you where you want to put this, but it can be for example a folder called "ngsworkflow" on Desktop. You need to have write permission in this folder.    
