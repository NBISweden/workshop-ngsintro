...
```
 Please follow the usage examples on those pages to recalibrate the base quality scores in your data. If you would like more help you can sneak peek at our example solution for HG00097 below. 
```{r,accordion=TRUE,block.title=TRUE,echo=FALSE,comment="",class.output="sh"}
...
2. If you have less data you can use [hard filters](https://software.broadinstitute.org/gatk/documentation/article?id=2806). 
