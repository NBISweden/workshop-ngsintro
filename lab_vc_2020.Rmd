...
Now you have your first vcf file, that contains the raw variants in the region chr2:136545000-136617000 in sample HG00097. 
Next you should explore the file using some basic text mining. 
Now you have your first vcf file with 

you should explore the vcf file using some basic linux commands. 



grep
### Question
9. What new files were generated with the command above? 
10. What is the file that ends with *idx*?
10. How many lines of meta data does your vcf file have?
11. How many data lines (variants) does your vcf file have?
Type the command ´grep '#CHROM' HG00097.vcf` to see what data columns your vcf file has. 
