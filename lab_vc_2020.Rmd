...
```{r,echo=FALSE,comment="",class.output="bash", class.source="badCode"}
...
Here you will align the reads of twp additional samples to the reference genome. You will then detect short variants in all three sampes and emitt the output in g.vcf format 
