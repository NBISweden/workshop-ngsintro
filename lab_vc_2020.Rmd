...
**Questions**  
* How many lines do the comined.g.vcf file have? You can use the linux command 'grep -v "#" filename.txt' to extract all lines that don't start with "#", then '|', and then 'wc' to count those lines.  
