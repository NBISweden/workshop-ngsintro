...
2. If you have time, the next part of the workflow will show you how to perform joint variant calling on three samples. You will combine individual linux commands into a workflow that can be started as an SBATCH script.
...
# Joint variant calling in cohort
...
# GATK's best practise short variant calling
