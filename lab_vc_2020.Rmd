...
8. Can you estimate the coverage by looking at the bam file in IGV? Is the coverage evenly distributed?
...
Now you have your first vcf file containing the raw variants in the region chr2:136545000-136617000 in sample HG00097. 
...
```
The meta-information lines describe the content of the data lines. The lines starting with *##INFO* defines how the data in the *INFO* column is encoded, and the lines starting with *##FORMAT* defines how the info the FORMAT column is encoded and in the *INFO* column
Please have a look at [The Variant Call Format specification](https://samtools.github.io/hts-specs/VCFv4.2.pdf) for more information about vcf files.

### Questions
9. What is the file *HG00097.vcf.idx*?
10. How many meta-information lines does your vcf file contain? The linux command `grep "^##" HG00097.vcf | wc` extracts all lines in HG00097.vcf starting with *##*, and counts these lines. 
...
12. How does the header line look in your sample? You can view it with the command ´grep '#CHROM' HG00097.vcf`.
13. What do the *FORMAT* column of the data lines tell you? Remember that the abbreviations shown in the *FORMAT* column is defined in the meta-inforamtion lines starting with *##FORMAT*.
14. What do the *HG00097* column of the data lines tell you?
