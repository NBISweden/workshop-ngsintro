...
# Part two 
Here you will align reads and perform variant calling in two additional samples. This time you will emitt the output from variant calling in the individual samples in g.vcf format, and subsequenclty perform joint variant calling of the "cohort".
![](data/ngs-workflow/2_jointvc.png)


If you want to you can run all commands one by one in the terminal, as you did in the first step of the workshop. However, you can also create  scripts to run several steps at a time. 
