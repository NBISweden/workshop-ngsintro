...
* In paths, replace `<username>` with your actual UPPMAX username.
* In commands, replace `<parameter>` with the correct parameter type, for example your input file name, output file name, directory name, etc. 
