...
# Introduction
Rapidly dropping sequencing costs and the ability to obtain valuable information about the entire genetic code has made Whole-genome sequening (WGS) a powerful research tool. The 1000 Genomes Project was the first project to sequence the entire genomes of a large number of people, to provide a comprehensive resource on human genetic variation. Data from the 1000 Genomes Project was quickly made available to the worldwide scientific community through freely accessible public databases. In this workshop we will use 3 samples from the 1000 Genomes project, and look in detail at a small regions on chromosome 2 around the LCT gene. We will look at genetic variants in this region that has been shown to control how lactose is tolerated in adults. 
  
In the first part of the workshop we will run a basic variant calling workflow consisting of quality control, Alingment of reads to the reference genome, and variant calling in one of the samples. 
  
In the second part of the workshop we will learn how to perform joint variant calling in all three samples. 
  
In the third part of the workshop we will look in more detail at GATK best practise variant calling, and try to follow their principles on our three samples. 
...
To learn more about GATK and their best practises workflows, please visit [their website](https://gatk.broadinstitute.org/hc/en-us)
