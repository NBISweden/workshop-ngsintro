...
# Introduction
Whole-genome sequencing (WGS) is a comprehensive method for analyzing entire genomes. This workshop will take you thourgh the process of calling short variants (SNPs and indels) in whole geonome sequence data from three human samples. 
...
3. If you have time, the last part of the workshop will take you through the GATK best practise for germline short variant detection for our three samples. The aim here is that you should learn how to use GATK's documentatiton to analyze your own samples in the future.    
