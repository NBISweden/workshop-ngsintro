...
<table>
  <tr>
    <td><i class="fab fa-linux"></i> Linux:</td><td>Use Terminal (Included by default).</td>
  </tr>
  <tr>
    <td><i class="fab fa-apple"></i> OSX:</td><td>Use Terminal (Included by default).</td>
  </tr>
  <tr>
    <td><i class="fab fa-windows"></i> Windows:</td><td>Use Powershell or Command prompt, both should be installed by default.</td>
  </tr>
</table> 
