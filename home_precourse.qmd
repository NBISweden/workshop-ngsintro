...
You will have to have 2 different accounts to complete the labs in this course; one in [SUPR](https://supr.naiss.se/) to handle the other account, and one at the compute center [PDC](https://www.pdc.kth.se/) in Stockholm.
...
Remote computing cluster Dardel at PDC will be use during the course. After making sure you have an accepted user agreement, go to the [**SUPR/NAISS Projects**](https://supr.naiss.se/project/) page and request membership to the project ID: [**{{< meta id_project >}}**]{.badge}
