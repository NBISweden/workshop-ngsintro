...
Log in to [SUPR/SNIC](https://supr.snic.se/) and request membership to the project IDs **`r paste0(upid)`**, **`r paste0(upstore)`** and **`r paste0(nscid)`**.
...
# Install tools for SSH & SFTP access
...
**Connect to UPPMAX:** Open the terminal (Windows users can use MobaXterm) and type `ssh -Y username@rackham.uppmax.uu.se`, then enter your password. The password will not be visible as you type.

**Create a user folder: ** Run the following below.
