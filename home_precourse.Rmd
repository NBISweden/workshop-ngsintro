...
Zoom is used for video-conferencing, lectures and group exercises. Please install/update to the latest version of [Zoom](https://zoom.us/).

# Connect to UPPMAX

See "Connecting to UPPMAX" instructions on the **Content** page.
