...
upid <- yaml::read_yaml("_site.yml")$nsc_project
...
Log in to [SUPR/SNIC](https://supr.snic.se/) and request membership to the project IDs **`r paste0(upid)`** and **`r paste0(upid)`**.
