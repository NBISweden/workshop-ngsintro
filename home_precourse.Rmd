...
<img src="data/common/supr-tetralith.png" class="fancyimage">
...
Note: You will get one user name & password for the account on UPPMAX, and one user name and password for the account on NSC. Please keep track of both, we will tell you when to use which account during the course. 

### SSH & SFTP access

You need a program to connect to a remote cluster (UPPMAX and NSC). Linux and Mac users already have terminal on their systems.
...
Please install IGV on your local system before the start of the course. 
...
We will use R on Uppmax and therefore, you do not need to install it on your own system. Alternatively, if you would like to try it out on your own system, instructions are given below.
