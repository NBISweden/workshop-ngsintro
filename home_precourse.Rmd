...
Note: You will get one user name & password for the account on UPPMAX, and one user name and account on NSC. Please keep track of both of them, we will tell you when to use which account during the course. 
