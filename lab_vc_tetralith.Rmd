...
We recommend you to incorporate the new steps into a script similar to the one you created above for [joint variant calling](#sbatchscript). You might find it helpful to try each step for one sample in the terminal, so that you know that a particular command works before you incorporate it in the script. Please try to complete the script for GATK's best practices workflow. If you run out of time you can look at our example solution below. 
```{r,accordion=TRUE,block.title=TRUE,echo=FALSE,comment="",class.output="sh"}
cat(paste0('#!/bin/bash
