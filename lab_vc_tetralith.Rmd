...
Unless something else is specified, the rest of the instructions assumes that you runnig the UPPMAX singularity container from an interactive session on Tetralith, and that you are located in your *Clusetr worksplace*.  
