...
```{r,echo=FALSE,comment="",class.output="bash"}
cat(paste0('interactive -A ',nscid,' -t 04:00:00 -n 1 &'))
```
...
```{r,echo=FALSE,comment="",class.output="bash"}
cat(paste0('singularity shell -B /proj/snic2020-13-57/users:/proj/g2020009/nobackup /proj/snic2020-13-57/ngsintro_homemade.5.sif'))
```
...
### Cluster workspace
Creating a workspace for this exercise, and then move into it. This folder will be referred to as your *Cluster workspace* throughout this workshop.
```{r,echo=FALSE,comment="",class.output="bash"}
...
```{r,echo=FALSE,comment="",class.output="bash"}
cat(paste0('/proj/',nscid,'/users/<username>/ngsworkflow\n'))
```
