...
```
Note that your terminal prompt changed to something like `<nsc_username>@n424 $`, which means that you are now running on one of the compute nodes. 
...
```
Note that your terminal prompt changed to something like `<nsc_username>@fake-uppmax$`. This means that you have moved into a "virtual computer" that mimics the UPPMAX environment.    
