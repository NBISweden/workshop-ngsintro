...
s <- s %>%
  ...
  # add links to topic
  dplyr::mutate(topic=ifelse(is.na(link_slide),topic,paste0("<span>",topic,"<a href='",link_slide,"'><i class='fas fa-youtube' style='margin-left:4px;margin-right:4px;'></i></a></span>"))) %>%
  mutate(topic=ifelse(is.na(link_lab),topic,paste0("<span>",topic,"<a href='",link_lab,"'><i class='fas fa-file-alt' style='margin-left:4px;margin-right:4px;'></i></a></span>"))) %>%
   mutate(topic=ifelse(is.na(link_room),topic,paste0("<span>",topic,"<a href='",link_room,"'><i class='fas fa-file-alt' style='margin-left:4px;margin-right:4px;'></i></a></span>"))) %>%
